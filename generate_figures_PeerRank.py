...
def generate_fig4a_category_rankings(data: dict, output_dir: Path):
    ...
    plt.tight_layout()
    save_figure(fig, output_dir, 'fig4a_category_rankings')
...
def main():
    ...
    generate_fig4a_category_rankings(data, output_dir)
