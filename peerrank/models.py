...
ALL_MODELS = [
    {"peerrank": True, "provider": "openai", "model_id": "gpt-5.6", "name": "gpt-5.6-sol", "cost": (5.00, 30.00)},  
    ...
    {"peerrank": True, "provider": "google", "model_id": "gemini-3.7-flash", "name": "gemini-3.7-flash", "cost": (1.50, 7.50)},
