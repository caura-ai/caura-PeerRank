...
ALL_MODELS = [
    {"peerrank": True, "provider": "openai", "model_id": "gpt-5.6", "name": "gpt-5.6", "cost": (5.00, 30.00)},  # aka "sol", flagship tier
    ...
    {"peerrank": False, "provider": "anthropic", "model_id": "claude-opus-5", "name": "claude-opus-5", "cost": (5.00, 25.00)},
    ...
    {"peerrank": False, "provider": "google", "model_id": "gemini-3.6-flash", "name": "gemini-3.6-flash", "cost": (1.50, 7.50)},
    {"peerrank": False, "provider": "grok", "model_id": "grok-4.5", "name": "grok-4.5", "cost": (2.00, 6.00)},
    {"peerrank": False, "provider": "deepseek", "model_id": "deepseek-v4-flash", "name": "deepseek-v4-flash", "cost": (0.14, 0.28)},
    {"peerrank": False, "provider": "together", "model_id": "meta-llama/Llama-3.3-70B-Instruct-Turbo", "name": "llama-3.3-70b", "cost": (0.88, 0.88)},  # Llama 4 not available serverless on Together (needs dedicated endpoint)
    ...
    {"peerrank": False, "provider": "anthropic", "model_id": "claude-fable-5", "name": "claude-fable-5", "cost": (10.00, 50.00)},
