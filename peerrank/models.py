...
ALL_MODELS = [
    ...
    {"peerrank": True, "provider": "openai", "model_id": "gpt-5.4", "name": "gpt-5.4", "cost": (2.5, 15.00)},
    ...
    {"peerrank": True, "provider": "google", "model_id": "gemini-2.5-flash", "name": "gemini-2.5-flash", "cost": (0.30, 2.50)},
    ...
    {"peerrank": False, "provider": "deepseek", "model_id": "deepseek-reasoner", "name": "deepseek-reasoner", "cost": (0.28, 0.42)},   
    ...
    {"peerrank": False, "provider": "kimi", "model_id": "kimi-k2.5", "name": "kimi-k2.5", "cost": (0.60, 3.00)}, 
