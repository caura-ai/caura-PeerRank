...
# Model selection
python peerrank.py --models gpt-5.5,claude-opus-4-8     # Include only these
...
python peerrank.py --judge claude-opus-4-8    # Set Phase 5 judge model
...
| Google | gemini-3-pro-preview, gemini-3.6-flash |
| xAI | grok-4.3 |
